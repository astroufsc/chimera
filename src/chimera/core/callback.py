...
def callback(manager):
    """Callback decorator.
    Use this decorator to add a callback object to an active Manager.
    This decorator returns a ProxyMethod that you use to subscribe
    to an event (using += operator)
