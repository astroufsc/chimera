...
class doStuff:
    ...
    def __init__(self, options, args):
        ...
        try:
            ...
            print(
                "Couldn't find current Chimera instance. Is Chimera running?",
                file=sys.stderr,
            )
            sys.exit(1)
        ...
        if options.list or options.listdetail:
            print(
                "Chimera - %s:%d"
                % (self.locManager.getHostname(), self.locManager.getPort())
            )
...
if __name__ == "__main__":
    ...
    remman.add_option(
        ...
        dest="host",
        type="string",
        help="Host name/IP of manager to connect to" "; [default=%default]",
        metavar="HOST",
    )
    ...
    remman.add_option(
        ...
        dest="port",
        type="string",
        help="Port of manager to connect to" "; [default=%default]",
        metavar="PORT",
    )
